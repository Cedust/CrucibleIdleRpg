...
| [backlog/](backlog/)         | „Was ist offen, was wird als Nächstes gebaut?" | Zwei getrennte Gattungen ([backlog/README.md](backlog/README.md)): **offene Fragen** in [OPEN_ISSUES.md](backlog/OPEN_ISSUES.md) — nichts davon ist entschieden, kein Agent implementiert daraus — und der **Arbeitsvorrat** aus [ROADMAP.md](backlog/ROADMAP.md) + [tasks/](backlog/tasks/) |
