...
**020** bleibt unabhängig von 019 und kann parallel zu 021 umgesetzt werden. Der Meilenstein ist
reine View-Arbeit: Simulation, Stores und Save-Schema bleiben unverändert.
