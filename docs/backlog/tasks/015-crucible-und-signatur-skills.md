...
Der Crucible investiert Relic Shards in die Trees Anvil Sparks, Smelting Flames und die vier
...
- [Crucible](../../spec/PROGRESSION.md#3-crucible-globaler-skilltree) — drei Trees, Rangkosten
  `n` Relic Shards, permanenter Anvil-Tree und je ein kostenloser Tree-Respec für Smelting und Molten
- [Anvil Sparks](../../spec/PROGRESSION.md#31-anvil-sparks) — `anvil.waystones` Rang `n` öffnet
  `A1-D<n+1>` und verlangt den Abschluss von `A1-D<n>`; Ausrüstung, Handwerk und Runen bleiben
  gesperrt
...
- [Kapazität](../../spec/PROGRESSION.md#34-kapazität) —
  `130` aktive Relic-Shard-Kosten gegen `117` Relic Shards aus Akt 1

## Akzeptanzkriterien

- [ ] Ein Rang kostet genau seine Rangnummer in Relic Shards; ein voll gestufter Node kostet `15` und
      cappt bei Rang 5
- [ ] Kaufbar ist nur, wer bezahlbar ist und alle Voraussetzungen erfüllt; gesperrte Nodes
      (Armory, Blacksmith, Jeweler, die vier Runen-Nodes und die vier Molten-Vertiefungen) sind sichtbar und
      nicht kaufbar
...
- [ ] Anvil-Ränge sind nicht respecbar; Smelting und Molten besitzen je einen unabhängigen,
      ...
      exakt die investierten Relic Shards erstattet
...
- [ ] Der Crucible-Screen zeigt die drei Trees mit Rängen, Kosten, Voraussetzungen, Sperrgründen
