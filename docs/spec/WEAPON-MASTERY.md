...
- `WEAPON MASTERY` ist ein eigener Sidebar-Eintrag im charaktergebundenen Block. Reihenfolge,
  Blöcke und Portrait-Switcher stehen im
  [Viewport- und Screen-Contract](UI.md#1-viewport--und-screen-contract).
