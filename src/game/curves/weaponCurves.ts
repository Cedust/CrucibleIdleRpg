 ...
 * Angriff gewürfelt (docs/spec/DAMAGE-SYSTEM.md#11-charakter-zug-ausgehender-schaden).
 ...
 * docs/backlog/OPEN_ISSUES.md#1-offene-balancing-fragen--tuning-notizen (Waffen-Damage-Range-Breiten je Seltenheit).
